...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        if soft_warn:  # punch
            ...
            reply = (
                f"<code>⛔ /code><b>P⚠️unch Event👊</b>\n"
                f"<code> </code><b>•  𝙹𝚞𝚜𝚝 𝚐𝚘 𝚘𝚞𝚝 𝚗𝚍 𝚐𝚛𝚘𝚠 𝚞𝚙 𝚔𝚒𝚍𝚍😹💣:</b> {mention_html(user.id, user.first_name)}\n"
                f"<code> </code><b>•  Count:</b> {limit}")

        else:  # ban
            chat.kick_member(user.id)
            reply = (
                f"<code>🚫</code><b>𝙰𝚗𝚘𝚝𝚑𝚎𝚛 𝚖𝚒𝚗𝚍𝚕𝚎𝚜𝚜 𝚞𝚜𝚎𝚛 𝚐𝚘𝚝 𝚋𝚊𝚗🤣❣️</b>\n"
        ...
        reply = (
            f"<code>📛</code><b>Warn 𝙶𝚒𝚟𝚎 𝚞 𝚊𝚗𝚘𝚝𝚑𝚎𝚛 𝚌𝚑𝚊𝚗𝚌𝚎 𝚕𝚘𝚕 𝚔𝚒𝚍𝚍😼</b>\n"
            f"<code> </code><b>•  𝙺𝚒𝚍𝚍 😼 𝚞𝚜𝚎𝚛:</b> {mention_html(user.id, user.first_name)}\n"
