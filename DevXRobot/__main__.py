...
buttons = [
    ...
    [
        InlineKeyboardButton(text="❣️𝙼𝚢 𝙾𝚠𝚗𝚎𝚛💞", url=f"https://t.me/DEVX_OWNER"),
        InlineKeyboardButton(
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("DevXRobot.modules." + module_name)
...
def zaid_about_callback(update, context):
    ...
    if query.data == "zaid_":
        query.message.edit_text(
            text=""" ℹ️ I am [𝗗𝗲𝘃ꗄ➺✘「🇮🇳」](t.me/DevX_Robot), a powerful group management bot built to help you manage your group easily.
                 ...
                 \n❍ Assistant @DEVX\_OWNER.
                 \nHere is the [JOIN](https://t.me/THN_BOTS_SUPPORT).
